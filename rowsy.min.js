...
var body=jQuery("body"),st=0,navText=['<i class="mdi mdi-chevron-left"></i>','<i class="mdi mdi-chevron-right"></i>'];function retinaLogo(){"use strict";var e=jQuery(".logo.regular"),t=jQuery(".logo.contrary"),i="(-webkit-min-device-pixel-ratio: 1.5), (min--moz-device-pixel-ratio: 1.5), (-o-min-device-pixel-ratio: 3/2), (min-resolution: 1.5dppx)";""!=rowsyParams.logo_regular&&(1<window.devicePixelRatio||window.matchMedia&&window.matchMedia(i).matches)&&e.each(function(e,t){jQuery(t).prop("width",jQuery(t).width()),jQuery(t).prop("height",jQuery(t).height()),jQuery(t).attr("src",rowsyParams.logo_regular)}),""!=rowsyParams.logo_contrary&&(1<window.devicePixelRatio||window.matchMedia&&window.matchMedia(i).matches)&&(t.prop("width",t.width()),t.prop("height",t.height()),t.attr("src",rowsyParams.logo_contrary))}function fitVids(){"use strict";body.fitVids()}function megaMenu(){"use strict";jQuery(".menu-posts").not(".owl-loaded").owlCarousel({items:5,margin:15})}function hero(){"use strict";if(body.hasClass("with-hero")){if(jQuery(".hero-image .hero").length&&jQuery(".hero-strings").length)new Typed(".hero-heading span",{backDelay:3e3,backSpeed:20,cursorChar:"_",stringsElement:".hero-strings",typeSpeed:30});if(jQuery(".hero-gallery .hero").length)jQuery(".hero-gallery .hero").imagesLoaded({background:".slider-item"},function(){jQuery(".hero-slider").owlCarousel({animateOut:"fadeOut",dots:!1,items:1,mouseDrag:!1,nav:!0,navText:navText,onInitialized:function(e){jQuery(".hero-slider").find(".owl-item:nth-child("+(e.item.index+1)+")").addClass("finished")},onTranslated:function(e){jQuery(".hero-slider").find(".owl-item").removeClass("finished"),jQuery(".hero-slider").find(".owl-item:nth-child("+(e.item.index+1)+")").addClass("finished")},touchDrag:!1})})}}function featured(){"use strict";jQuery(".featured-content").not(".owl-loaded").owlCarousel({animateOut:"fadeOut",autoplay:!0,autoplayHoverPause:!0,dotsData:!0,items:1,loop:!0,smartSpeed:1e3})}function initStickyDate(){"use strict";jQuery(".date-header").each(function(){var e=jQuery(this);e.data("height")||(e.data({height:e.outerHeight(),original_pos:e.offset().top-jQuery("#wpadminbar").height(),width:e.outerWidth()}),e.wrap('<div class="header-wrap"></div>'),e.parent().css({height:e.data("height"),width:e.data("width")}))})}function scrollStickyDate(){"use strict";st=jQuery(window).scrollTop();var o=jQuery(".date-header"),r=jQuery(".site");o.each(function(e){var t=jQuery(this),i=o.eq(e+1),a=o.eq(e-1);t.data("original_pos")<=st?(t.addClass("sticky"),i.length&&t.offset().top>=i.data("original_pos")-t.data("height")&&t.addClass("collide").css("top",i.data("original_pos")-t.data("height")-parseInt(r.css("margin-top"))-r.prevAll().outerHeight(!0))):(t.removeClass("sticky"),a.length&&st<=t.data("original_pos")-a.data("height")&&a.removeClass("collide").removeAttr("style"))})}function picks(){"use strict";jQuery(".picked-posts").not(".owl-loaded").owlCarousel({autoHeight:!0,autoplay:!0,autoplayHoverPause:!0,autoplaySpeed:500,autoplayTimeout:3e3,items:1,loop:!0})}function offCanvas(){"use strict";var e=jQuery(".burger"),t=jQuery(".off-canvas"),i=jQuery(".canvas-close");jQuery(".main-menu .nav-list").slicknav({label:"",prependTo:".mobile-menu"}),jQuery(".site-content").find(".widget-area").clone().appendTo(t),e.on("click",function(){body.toggleClass("canvas-opened"),body.addClass("canvas-visible"),dimmer("open","medium")}),i.on("click",function(){body.hasClass("canvas-opened")&&(body.removeClass("canvas-opened"),dimmer("close","medium"))}),jQuery(".dimmer").on("click",function(){body.hasClass("canvas-opened")&&(body.removeClass("canvas-opened"),dimmer("close","medium"))}),jQuery(document).keyup(function(e){27==e.keyCode&&body.hasClass("canvas-opened")&&(body.removeClass("canvas-opened"),dimmer("close","medium"))})}function gallery(){"use strict";jQuery(".entry-gallery.slider").not(".owl-loaded").owlCarousel({animateOut:"fadeOut",autoHeight:!0,dots:!1,items:1,nav:!0,navSpeed:500,navText:navText}),jQuery(".entry-gallery.justified-gallery").justifiedGallery({border:0,margins:6,rowHeight:200})}function photoSwipe(){"use strict";var t,i,a=jQuery(".pswp")[0],o=[];jQuery(".entry-gallery.justified-gallery").on("click",".gallery-item > a",function(e){e.preventDefault(),o=[],i=jQuery(this),t=i.parent().index(),jQuery.each(i.parent().siblings().andSelf(),function(e,t){o.push({h:parseInt(jQuery(t).find("a").attr("data-height")),src:jQuery(t).find("a").attr("href"),title:jQuery(t).find(".caption").text(),w:parseInt(jQuery(t).find("a").attr("data-width"))})}),new PhotoSwipe(a,PhotoSwipeUI_Default,o,{closeOnScroll:!1,history:!1,index:t,showAnimationDuration:0,showHideOpacity:!0,timeToIdle:2e3}).init()})}function search(){"use strict";var t=jQuery(".main-search"),e=t.find(".search-field");jQuery(".search-open").on("click",function(){body.addClass("search-open"),e.focus()}),jQuery(document).keyup(function(e){27==e.keyCode&&body.hasClass("search-open")&&body.removeClass("search-open")}),jQuery(".search-close").on("click",function(){body.hasClass("search-open")&&body.removeClass("search-open")}),jQuery(document).mouseup(function(e){!t.is(e.target)&&0===t.has(e.target).length&&body.hasClass("search-open")&&body.removeClass("search-open")})}function pagination(){"use strict";var e=jQuery(".posts-wrapper"),a=jQuery(".infinite-scroll-button"),t={append:e.selector+" > *",debug:!1,hideNav:".posts-navigation",history:!1,path:".posts-navigation .nav-previous a",prefill:!0,status:".infinite-scroll-status"};body.hasClass("pagination-infinite_button")&&(t.button=a.selector,t.prefill=!1,t.scrollThreshold=!1,e.on("request.infiniteScroll",function(e,t){a.text(rowsyParams.infinite_loading)}),e.on("load.infiniteScroll",function(e,t,i){a.text(rowsyParams.infinite_load)})),(body.hasClass("pagination-infinite_button")||body.hasClass("pagination-infinite_scroll"))&&body.hasClass("paged-next")&&(e.infiniteScroll(t),e.on("append.infiniteScroll",function(e,t,i,a){initStickyDate()}))}function stickySidebar(){"use strict";var e=45;jQuery("#wpadminbar").length&&(e+=32),jQuery(".sidebar-column").theiaStickySidebar({additionalMarginTop:e,additionalMarginBottom:45})}function like(){"use strict";var t,i,e=jQuery(".like");jQuery.each(e,function(e,t){"1"==Cookies.get("rowsy-like-"+jQuery(t).attr("data-id"))&&(jQuery(this).addClass("liked"),jQuery(this).attr("title",rowsyParams.unlike_title))}),jQuery(".site-main").on("click",e.selector,function(e){e.preventDefault(),t=jQuery(this).attr("data-id"),(i=jQuery(this)).addClass("liking"),"1"==Cookies.get("rowsy-like-"+t)?jQuery.ajax({type:"POST",url:rowsyParams.admin_url,data:{action:"rowsy_unlike",post_id:t,nonce:rowsyParams.unlike_nonce},success:function(e){Cookies.remove("rowsy-like-"+t,{path:"/"}),i.find(".count").text(e),i.removeClass("liking liked"),i.attr("title",rowsyParams.like_title)}}):jQuery.ajax({type:"POST",url:rowsyParams.admin_url,data:{action:"rowsy_like",post_id:t,nonce:rowsyParams.like_nonce},success:function(e){Cookies.set("rowsy-like-"+t,"1",{expires:365,path:"/"}),i.find(".count").text(e),i.removeClass("liking").addClass("liked"),i.attr("title",rowsyParams.unlike_title)}})})}function share(){"use strict";var e=jQuery(".action-share"),i=0;e.on("click",function(){jQuery(this).toggleClass("opened")}),e.find(".links a").each(function(e,t){jQuery(t).css("transitionDelay",i+"s"),i+=.03})}function dimmer(e,t){"use strict";var i=jQuery(".dimmer");switch(e){case"open":i.fadeIn(t);break;case"close":i.fadeOut(t)}}window.lazySizesConfig=window.lazySizesConfig||{},window.lazySizesConfig.loadHidden=!1,jQuery(function(){"use strict";retinaLogo(),fitVids(),megaMenu(),hero(),featured(),picks(),offCanvas(),gallery(),photoSwipe(),search(),pagination(),stickySidebar(),like(),share()}),jQuery(window).load(function(){"use strict";initStickyDate()}),jQuery(window).scroll(function(){"use strict";window.requestAnimationFrame(scrollStickyDate)}),document.addEventListener("lazyloaded",function(e){var t={disableParallax:/iPad|iPhone|iPod|Android/,disableVideo:/iPad|iPhone|iPod|Android/,speed:.1};(jQuery(e.target).parents(".hero").length||jQuery(e.target).hasClass("hero"))&&jQuery(e.target).jarallax(t),jQuery(e.target).parents(".post-list.cover").length&&jQuery(e.target).parent().jarallax(t),jQuery(e.target).parents(".entry-gallery.slider").length&&jQuery(e.target).parents(".entry-gallery.slider").trigger("refresh.owl.carousel")});
